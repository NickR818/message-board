...
<body>
	...
	<?php
		...
		if(file_exists("messages.txt") === false || filesize("messages.txt") === 0) {
			...
			// look through each post in the messageArray to build a table row
			for($i = 0; $i < $count; ++$i) {
				...
				echo "<td style='text-align: center;' width='10%'><a href='messageBoard.php?action=Delete%20Message&message=$i'>Delete This Message</a></td>";
				echo "</tr>\n";
			} // end of for loop
			echo "</table>\n";
		} // end of if/else
